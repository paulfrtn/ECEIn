...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="notif_styles.css">
  <script type="text/javascript" src="notif_script.js"></script>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      var choix = 0;
      triNotifications(choix);

      $(".choix").click(function () {
        choix = $(this).data("choix-id");
        triNotifications(choix);
      });
    });

    function triNotifications(choix) {
      $.ajax({
        url: 'notifFilter.php',
        method: 'POST',
        data: { choix: choix },
    ...
    <a class="navbar-brand" href="#"> <a href="../Accueil/accueil.php"><img src="../../images/logos/logo.png" alt="logo"
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="notifications.php">Notifications</a>
                        </li>
    ...
    <div class="notifcontainer">
      <div class="bloc2">
        ...
        <div class="bloc3">
          ...
          <div class="tri">
            <button class="choix" data-choix-id="1">Les plus recentes</button>
            <button class="choix" data-choix-id="2">Les plus anciennes</button>
            <button class="choix" data-choix-id="3">A-Z</button>
          </div>


          <div class="a">
            <div class="avatar">
              <svg id="Camada_1" width="190px" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 251.5 430.6"
                enable-background="new 0 0 251.5 430.6" xml:space="preserve">
                <g id="camisacostas">
                  <path fill="#383838"
                ...
                <g id="cabeca">
                  ...
                  <g id="cabelo">
                    <g id="lados">
                      ...
                      <g>
                        <path fill="#3D332D"
                          d="M84.2,65.4c0,0-5.6,11.5-9.6,14c0,0,7.8-12.3,8-14c0.2-1.8,0.2-1.8,0.2-1.8L84.2,65.4z"></path>
                      </g>
                      <g>
                        <path fill="#3D332D"
                          d="M73.8,113.5c0,0-3.2-13.9-3.2-15.6c0-1.8,0.2-4.9,0.2-4.9s-1.8,8.3,0,14.2L73.8,113.5z"></path>
                      </g>
                      <g>
                    ...
                    <g id="franja">
                      ...
                      <g>
                        <path fill="#3D332D"
                          d="M83.7,57.8c0,0,12,2.9,15.3,2.6c3.4-0.2,9.1-2.2,9.1-2.2S103.1,65.9,83.7,57.8z"></path>
                      </g>
                      <g>
                        <path fill="#3D332D"
                          d="M154,17.6c0,0-5.2,12.9-6.7,14.1c-1.4,1.2-4.5,3.8-4.5,3.8s7.7-2.9,9.8-9.1L154,17.6z"></path>
                      </g>
                      <g>
                        <path fill="#3D332D" d="M150.7,66.4c0,0,15.1-5.8,17.1-10.9c0,0-19.7,11-22.3,11.8L150.7,66.4z">
                        </path>
                      </g>
                    </g>
                  </g>
                  <g id="sobrancelhas">
                    ...
                    <g>
                      <path fill="#3D332D" d="M151.5,91.5c0,0-16.8-9.6-14.2-12.2C139.9,76.8,151.5,91.5,151.5,91.5z">
                      </path>
                    </g>
                  </g>
                  <g id="nariz">
                ...
                <g id="pernas">
                  ...
                  <g id="notebook">
                    ...
                    <radialgradient id="luzmacae_1_" cx="121.6441" cy="239.6875" r="17.2316"
                      gradientunits="userSpaceOnUse">
                      <stop offset="0" style="stop-color:#FFFFFF"></stop>
                      <stop offset="0.9458" style="stop-color:#FFFFFF;stop-opacity:0"></stop>
                    </radialgradient>
                    <path id="luzmacae" opacity="0.66" fill="url(#luzmacae_1_)"
                  ...
                  <g id="pe">
                    ...
                    <g>
                      <rect x="161.9" y="353.5" transform="matrix(0.9869 0.1612 -0.1612 0.9869 59.7596 -21.5769)"
                        fill="#777070" width="1.9" height="7.9"></rect>
                    </g>
                    <g>
                      <rect x="165.3" y="353.9" transform="matrix(0.9821 0.1884 -0.1884 0.9821 70.3837 -24.9184)"
                        fill="#777070" width="1.9" height="7.6"></rect>
                    </g>
                    <g>
                      <rect x="168.4" y="354.8"
                        transform="matrix(0.9989 4.593970e-002 -4.593970e-002 0.9989 16.6397 -7.4027)" fill="#777070"
                        width="1.9" height="7"></rect>
                    </g>
                    <g>
                      <rect x="171.7" y="355.6" transform="matrix(0.9914 0.1308 -0.1308 0.9914 48.3763 -19.4954)"
                        fill="#777070" width="1.9" height="6.1"></rect>
                    </g>
                  </g>
                  <g>
