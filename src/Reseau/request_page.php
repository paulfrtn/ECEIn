            ...
            <div class="relat_contain">
                <div class="upper_contain">
                    ...
                    <div class="up_cont_down">
                        ...
                        INNER JOIN ami
                        ON utilisateur.id_utilisateur = ami.id_utilisateur
                        WHERE ( ami.id_utilisateur_ami = $user_id) AND ami.ami_accept = 2
                        ...
                        ";
                            ...
                            while ($row = mysqli_fetch_assoc($f_result)) {
                                echo '
        <div class="card req" id="' . $row['id_utilisateur'] . '">
            <div class="prof_pic">
            ...
            <div class="prof_txt">
                ...
                <div class="prof_desc">
                    <button class ="req_page" id = "'.$row['id_utilisateur'].' ">Accepter</button><br>
                </div>
            </div>
        </div>';
